...
void main(){
  ...
  float limitRange = u_innerLimit - u_outerLimit; // 限定返回
  float inLight = clamp((dotFromDirection - u_outerLimit) / limitRange, 0.0, 1.0); // 获取三个参数中大小处在中间的那个值，但是当limitRange为0时，会出现undefined
