...
import lightCubeVs from './4.2.light_cube.vs'
import lightCubeFs from './4.2.light_cube.fs'
import materialsVs from './4.2.light_maps.vs'
import materialsFs from './4.2.light_maps.fs'
